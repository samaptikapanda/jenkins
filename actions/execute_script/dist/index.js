...
async function run() {
  try {
    ...
    let body_1 = {
      ...
      RepoName: "AZUREDEVOPS-snowflake_deploy",
      SystemType: "SNOWFLAKE",
      SourceSystemName: "SNOWFLAKE_TEST",
      TargetSystemName: "SNOWFLAKE_TEST2",
      SchemaName: "DBO",
      HeadBranch: "",
      BaseBranch: "main",
      Path: "Migration",
    ...
    const TokenFetchResponse = await fetch(
      "http://40.78.156.172/api/v1/users/login-user",
      {
        method: "post",
    ...
    const resp = await fetch(
      "http://40.78.156.172/api/v1/4d/ci/cd/execute-system-ddl-query",
      {
        method: "post",
